...
var TD_SDK_CONFIG = {
    APPKEY: "D68ECFEAB4CABEA21A18AAAAAAAAAAAA",
    //APPKEY
    REQUEST_URL: 'https://paymenttest.bankcomm.com/g/w',
    // receive data server url
    REQUEST_CONF: '',
    //可视化采数拉取配置的服务url
    AUTO_SEND_EVENT: true,
    // true or false, The custom event trigger automatically sent data
    LOOP_SEND_DATA: false,
    // false or number(60) ,according to the time of you to set the cycle to send data, the unit is seconds, not less than 60 seconds
    TDID_POLICY: 'UUID',
    // UUID or FINGER, TDID generation strategy, It is recommended to use UUID
    SDK_VERSION: 'H5+APP+v5.0.0.6',
    // Do not modify
    PAGE_TITLE: false,
    //是否自动采集页面title
    HYBRID_PAGE_NAME: '',
    //混合模式页面是采集url还是title,默认采集url。如果参数配置是title，混合模式只采集页面title。
    EVENT_BY_ELEMENT: true,
    //是否允许通过元素属性td-event进行事件埋点
    WEB_VIEW_FLAG_UA: 'com.bankcomm.maidanba',
    //用于验证是否webview环境
    USER_CLICK_MAP: false,
    //是否采集用户点击图数据,
    USER_CLICK_MAP_REQURL: "http://dev.dmp.tdsh.com/sdk/userClickMap",
    //获取配置热力图页面URL
    MODE: "Hybird",
    HYBIRD_TYPE: "bridge"
};

var __TDIsIos__, __TDIosWebkit__, __TDIsAndroid__, __TDIsH5__;
var __TDBridgeLoader__ = __TDBridgeLoader__ || {
    loadUrl: function(e) {
        __TDIsIos__ = true;
        //__TDIsH5__ = false
        if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.TDHybridBridge && window.webkit.messageHandlers.TDHybridBridge.postMessage) {
            __TDIosWebkit__ = true;
            __TDIsH5__ = false;
        } else if (window.TDHybridBridge && window.TDHybridBridge.execute) {
            window.TDHybridBridge.execute(e)
            __TDIsAndroid__ = true;
            __TDIsH5__ = false;
        } else {
            __TDIsH5__ = true;
        }
...
var tdUserAgentInfo = navigator.userAgent;
if (tdUserAgentInfo && (tdUserAgentInfo.toLowerCase().indexOf('iphone') != -1 || tdUserAgentInfo.toLowerCase().indexOf('ipad') != -1 || tdUserAgentInfo.toLowerCase().indexOf('ipod') != -1)) {
...
function loadTDSdk() {
    ...
    (function() {
        ...
        function pageLogout(e) {
            if (window.location.href.indexOf("tdTimecc") != -1)
                return !1;
            if (!DTGlobal.appkey)
                return !1;
            if (!eventState)
        ...
        function UrlRequest() {
            this.url = TD_SDK_CONFIG.REQUEST_URL,
            this.opts = {},
        ...
        (function() {
            ...
            neumedias.platform = function() {
                var e = window.navigator.userAgent
                  ...
                  , n = {};
                return t.match(/win32/gi) ? (n.os = "windows",
                e.match(/windows\s+nt\s+5\.1/gi) ? (n.type = "desktop",
                n.code = "xp") : e.match(/windows\s+nt\s+6\.0/gi) ? (n.type = "desktop",
                n.code = "vista") : e.match(/windows\s+nt\s+6\.1/gi) ? (n.type = "desktop",
                n.code = "7") : e.match(/windows\s+nt\s+6\.2/gi) ? (n.type = "desktop",
                n.code = "8") : e.match(/windows\s+nt\s+6\.3/gi) ? (n.type = "desktop",
                n.code = "8.1") : e.match(/windows\s+phone\s+7/gi) ? (n.type = "phone",
                n.code = "7") : e.match(/windows\s+phone\s+8/gi) && (n.type = "phone",
                n.code = "8")) : t.match(/macintel/gi) ? n.os = "macosx" : t.match(/iphone/gi) ? (n.os = "ios",
                n.type = "phone",
                n.code = "8") : t.match(/ipad/gi) ? (n.os = "ios",
                n.type = "tablet",
                n.code = "8") : t.match(/linux/gi) && (e.match(/android/gi) ? (n.os = "android",
                n.type = "mobile") : e.match(/cros/gi) ? (n.os = "chromeos",
                n.type = "desktop") : e.match(/ubuntu/gi) ? (n.os = "ubuntu",
                n.type = "desktop") : (n.os = "linux",
                n.type = "desktop")),
                n
            }
            ,
            ...
            neumedias.isMobile = function() {
                ...
                return console.log(),
                e.type == "mobile" || e.type == "phone" || e.type == "tablet"
            }
        }
        )(),
        window.TDJSON = {},
        function() {
            ...
            typeof TDJSON.stringify != "function" && (escapable = /[\\\"\u0000-\u001f\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
            meta = {
                "\b": "\\b",
                "	": "\\t",
                "\n": "\\n",
            ...
            typeof TDJSON.parse != "function" && (cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
            TDJSON.parse = function(text, reviver) {
                function walk(e, t) {
                    var n, r, i = e[t];
        ...
        var $$ = function(window) {
            ...
            function ajaxBeforeSend(e, t) {
                var n = t.context;
                if (t.beforeSend.call(n, e, t) === !1 || triggerGlobal(t, n, "ajaxBeforeSend", [e, t]) === !1)
                    return !1;
            ...
            function serializeData(e) {
                typeof e.data == "object" && (e.data = param(e.data)),
            ...
            function serialize(e, t, n, r) {
                ...
                for (var s in t) {
                    var o = t[s];
                    r && (s = n ? r : r + "[" + (i ? "" : s) + "]"),
                    !r && i ? e.add(o.name, o.value) : (n ? typeof o == "array" : typeof o == "object") ? serialize(e, o, n, s) : e.add(s, o)
                }
            }
            function param(e, t) {
                var n = [];
            ...
            function extend(e) {
                ...
                for (var r = 0; r < n.length; r++)
                    for (key in n[r])
                        n[r][key] !== undefined && (e[key] = n[r][key]);
                return e
            }
            var jsonpID = 0, document = window.document, key, name, rscript = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, scriptTypeRE = /^(?:text|application)\/javascript/i, xmlTypeRE = /^(?:text|application)\/xml/i, jsonType = "application/json", htmlType = "text/html", blankRE = /^\s*$/, ajax = function(options) {
                ...
                xhr.onreadystatechange = function() {
                    if (xhr.readyState == 4) {
                        ...
                        if (xhr.status >= 200 && xhr.status < 300 || xhr.status == 304 || xhr.status == 0 && protocol == "file:") {
                            ...
                            try {
                                dataType == "script" ? (1,
                                eval)(result) : dataType == "xml" ? result = xhr.responseXML : dataType == "json" && (result = blankRE.test(result) ? null : TDJSON.parse(result))
                            } catch (e) {
                                error = e
                            }
            ...
            ajax.post = function(e, t, n, r) {
                return typeof t == "function" && (r = r || n,
                n = t,
                t = null),
                ajax({
                    type: "POST",
        ...
        (function() {
            function e() {
                var e = !1
                  , t = []
                  , n = TD_SDK_CONFIG.WEB_VIEW_FLAG_UA;
                if (n) {
                    t.push(n);
                    var r = navigator.userAgent;
                    for (var i = 0; i < t.length; i++)
                        if (r && r.indexOf(t[i]) != -1) {
                            e = !0;
                            break
                        }
            ...
            function r(e) {
                DTGlobal.appkey = TD_SDK_CONFIG.APPKEY,
                DTGlobal.appProfile.versionName = "",
                DTGlobal.appProfile.versionCode = "";
                if (e) {
                    DTGlobal.appkey = e.getAttribute("td-appid") || DTGlobal.appkey;
                    var t = e.getAttribute("post-url")
                      , n = e.getAttribute("td-loop");
                    t && (TD_SDK_CONFIG.REQUEST_URL = t),
                    n && (TD_SDK_CONFIG.LOOP_SEND_DATA = n),
                    TD_SDK_CONFIG.SDK_VERSION.indexOf("H5+APP+") > -1 || TD_SDK_CONFIG.SDK_VERSION.indexOf("WEB+APP+") > -1 || (neumedias.isMobile() ? TD_SDK_CONFIG.SDK_VERSION = "H5+APP+" + TD_SDK_CONFIG.SDK_VERSION : TD_SDK_CONFIG.SDK_VERSION = "WEB+APP+" + TD_SDK_CONFIG.SDK_VERSION),
                    DTGlobal.appProfile.sdkVersion = TD_SDK_CONFIG.SDK_VERSION
                }
            }
            function i() {
                TDIsWebviewFlag = !0,
                window.TD_SDK_CONFIG = window.TD_SDK_CONFIG || {},
                TD_SDK_CONFIG.AUTO_SEND_EVENT = !0
            }
            function s() {
                var e = null;
                n(t(), function(t) {
                    if (t.getAttribute("td-appid") || t.getAttribute("td-hybrid-flag"))
                        return e = t,
                        !0
                }),
        ...
        function(e) {
            ...
            function r() {
                var e = null
                  , r = null;
                n(t(), function(t) {
                    if (t.getAttribute("td-appid"))
                        return r = t.getAttribute("td-appid"),
                        e = t,
                        !0
                }),
                r = r != null ? r : TD_SDK_CONFIG.APPKEY,
                DTGlobal.appkey = r,
                DTGlobal.appProfile.versionName = "",
                DTGlobal.appProfile.versionCode = "";
                if (e) {
                    var i = e.getAttribute("post-url")
                      , s = e.getAttribute("td-loop");
                    i && (TD_SDK_CONFIG.REQUEST_URL = i),
                    s && (TD_SDK_CONFIG.LOOP_SEND_DATA = s)
                }
            }
            r();
            var i = {
                ...
                getParam: function() {
                    var e = TDJSON.parse(TDJSON.stringify(DTGlobal))
                      , t = {
                        ...
                        deviceProfile: {
                            pixel: function() {
                                ...
                                return window.devicePixelRatio && e.push(window.devicePixelRatio),
                                e.join("*")
                            }()
                        },
                        msgs: function() {
                            ...
                            if (!e)
                                return [];
                            var e = TDJSON.parse(e).msg
                              , t = sessionStorage.getItem("__TD_SessionStart");
                            if (!t && localStorage.__TD_lastSession) {
                                var n = TDJSON.parse(localStorage.__TD_lastSession);
                                t = n.start
                            }
                            var r = sessionStorage.getItem("__TD_sessionId")
                              , i = (new Date).getTime()
                              , s = 0;
                ...
                del: function() {
                    ...
                    if (e && e.__TD_appkey && DTGlobal.appkey !== e.__TD_appkey) {
                        ...
                        this.getAjax(t);
                        for (var n in e)
                            n.indexOf("__TD_") > -1 && n != "__TD_deviceId" && delete window.localStorage[n];
                        window.sessionStorage.removeItem("__TD_SessionStart"),
                        window.sessionStorage.removeItem("__TD_sessionId")
                    }
                }
            };
            try {
          ...
          , H5Event = {
            ...
            getIeVersion: function() {
                ...
                if (navigator.userAgent.indexOf("MSIE") != -1) {
                    ...
                    e = t.split(";"),
                    e.length > 1 && (e = parseInt(e[1].replace(/[ ]/g, "").replace(/MSIE/g, "")))
                }
                return e
            },
            getUrlParam: function(e) {
                ...
                if (t.indexOf(e) != -1) {
                    var n = t.indexOf(e) + e.length
                      , r = t.indexOf("&", n) == -1 ? t.length : t.indexOf("&", n);
                    return t.substring(n, r)
                }
                return ""
            }
        };
        TDIsWebviewFlag || (H5Event.addEventListener(window, "pagehide", pageLogout),
        ...
        function(e, t, n) {
            ...
            var e = function(e) {
                ...
                ,
                typeof e == "object" ? (this.hasher = e.hasher,
                this.screen_resolution = e.screen_resolution,
                this.screen_orientation = e.screen_orientation,
                this.canvas = e.canvas,
                this.ie_activex = e.ie_activex) : typeof e == "function" && (this.hasher = e)
            };
            return e.prototype = {
                get: function() {
                    var e = [];
                ...
                murmurhash3_32_gc: function(e, t) {
                    ...
                    f = 0;
                    while (f < r)
                        a = e.charCodeAt(f) & 255 | (e.charCodeAt(++f) & 255) << 8 | (e.charCodeAt(++f) & 255) << 16 | (e.charCodeAt(++f) & 255) << 24,
                        ++f,
        ...
        var cookie = function(e, t, n) {
            ...
            if (n.expires && (typeof n.expires == "number" || n.expires.toUTCString)) {
                var i;
                typeof n.expires == "number" ? (i = new Date,
                i.setTime(i.getTime() + n.expires * 24 * 60 * 60 * 1e3)) : i = n.expires,
        ...
        UrlRequest.prototype = {
                  ...
                  , u = {
                    invoke: function(u) {
                        if (navigator.userAgent.indexOf("MSIE") > 0) {
                            ...
                            s == "HEATMAP" ? o.sendHeatMapMsg(e, t, n, r, i) : s == "SMART" ? o.sendSmartMsg(e, t, n, r, i) : o.sendMsg(e, t, n, r, i)
                    }
                };
                u.invoke({
                    url: t,
                    type: e,
                    param: TDJSON.stringify(n),
                    success: r
                })
            },
            ...
            send: function(e, t, n, r, i) {
                n = n || this.url,
                r = r || "post",
                this.getAjax(r, n, this.opts, e, t, i)
            },
            ...
            sendMsg: function(e, t, n, r, i) {
                ...
                localData.add("td-unique", "true"),
                TDONOFF = !1;
                var s = "json";
                if (e == "post" || e == "POST")
                    n = TDJSON.stringify(n),
                    s = "text";
                if (localData.get("td-sending-data"))
                ...
                var o = !1;
                TD_SDK_CONFIG && TD_SDK_CONFIG.REQUEST_ASYN && (o = TD_SDK_CONFIG.REQUEST_ASYN),
                TDXHR = $$.ajax({
                    type: e,
                    url: t,
                    data: n,
                    ...
                    complete: function() {
                        TDXHR = undefined,
                        TDONOFF = !0,
                        TDNUMBER && (DTMgr.getAjax(),
                        TDNUMBER = !1),
                        localData.delLocalStorage("td-sending-data"),
                        localData.delLocalStorage("td-unique")
                    }
                })
            }
        },
        function(e) {
            ...
            TDBASE.equal = function(e, t) {
                ...
                for (var s = 0, o = u.length; s < o; s++) {
                    if (!(u[s]in e && u[s]in t))
                        return !1;
                    if (typeof e[u[s]] == "object" && typeof t[u[s]] == "object")
                        n = TDBASE.equal(e[u[s]], t[u[s]]);
                    else if (e[u[s]] !== t[u[s]])
                        return !1
                }
                return n
            ...
            TDBASE.checkIsNeedCollectData = function(e) {
                ...
                if (TD_SDK_CONFIG.LIMIT_DATA_MAX_SIZE) {
                    var n = parseFloat(TD_SDK_CONFIG.LIMIT_DATA_MAX_SIZE)
                      , r = localData.get("sessionMsg");
                    if (r && e) {
                        var i = r.replace(/[^\x00-\xff]/g, "xx").length / 1024
                          , s = e.replace(/[^\x00-\xff]/g, "xx").length / 1024
                          , o = (i + s).toFixed(2);
                        parseFloat(o) > n && (t = !1,
                        i > n && (t = !0,
                        localData.delLocalStorage("lastSession"),
                        DTMgr.addlastSession()))
                    }
                }
                return t
            }
            ...
            TDBASE.addGenre = function(e, t, n, r, i, s) {
                if (!!localData.get("sessionMsg")) {
                    if (!TDBASE.checkIsNeedCollectData(TDJSON.stringify(e)))
                        return !1;
                    n && n(e);
                    var o = TDJSON.parse(localData.get("sessionMsg"))
                      , u = o.msg[o.msg.length - 1].data[t];
                    if (t === "events") {
                        if (u.length != 0) {
                            var a = !1;
                            for (var f = 0; f < u.length; f++)
                                if (TDBASE.equal(u[f], e)) {
                                    a = !0,
                                    u[f].count += 1,
                                    u[f].start = e.start;
                                    break
                    ...
                    if (t === "pages")
                        if (r) {
                            ...
                            if (l) {
                                l = TDJSON.parse(l);
                                var c = TDJSON.parse(TDJSON.stringify(l))
                                  , h = c.start;
                                c.duration = TDBASE.getDurationSecond(h, e.start),
                                u.push(c),
                                e.refer = c.name
                            }
                            i || (u.push(e),
                            localData.add("lastPage", TDJSON.stringify(e))),
                            localData.add("sessionMsg", TDJSON.stringify(o)),
                            s || TDAPP.send()
                        } else
                            u.push(e),
            ...
            TDBASE.lealSet = function(e) {
                ...
                var r = 0;
                t && (r = parseInt((e - t) / 1e3)),
                localData.add("leaveSession", r)
            }
            ,
            TDBASE.addMsg = function(e) {
                if (!localData.get("sessionMsg"))
                    localData.add("sessionMsg", TDJSON.stringify({
                        msg: [e]
                    }));
                else {
                    var t = TDJSON.parse(localData.get("sessionMsg"));
                    t.msg.push(e),
                    localData.add("sessionMsg", TDJSON.stringify(t))
                }
            }
        }(window),
        function() {
            if (!DTGlobal.appkey)
                return console.log("请配置APPKEY"),
                !1;
            if (TDIsWebviewFlag)
                return;
            window.localData = TalkingData.localStorage;
            var e = TalkingData.sessionStorage
              , t = 60
              ...
              , r = {
                ...
                set: function() {
                    ...
                    try {
                        ...
                        var i = TDJSON.parse(localData.get("sessionMsg"))
                          , s = TDBASE.getCommon(i);
                        this.getAjax()
                    } catch (r) {
                        console.log(r)
                    }
                    ...
                    if (localData.get("deviceId"))
                        ...
                        if (TD_SDK_CONFIG.TDID_POLICY == "FINGER") {
                            var e = new TalkingData.Fingerprint
                              ...
                              , n = e.get() + "" + t.get();
                            parseInt(n) == NaN ? this.deviceId = n : this.deviceId = parseInt(n).toString(16),
                            this.deviceId = this.deviceId.replace(/\.|\+|\(|\)/g, "")
                        } else
                            this.deviceId = this.uuid(16, 32);
                ...
                uuid: function(e, t) {
                    ...
                    if (e)
                        for (i = 0; i < e; i++)
                            r[i] = n[0 | Math.random() * t];
                    else {
                        var s;
                        r[8] = r[13] = r[18] = r[23] = "-",
                        r[14] = "4";
                        for (i = 0; i < 36; i++)
                            r[i] || (s = 0 | Math.random() * 16,
                            r[i] = n[i == 19 ? s & 3 | 8 : s])
                    }
                    return r.join("")
                },
                setSession: function() {
                    ...
                    if (this.deviceId.indexOf("-") > -1) {
                        ...
                        t = this.deviceId + i;
                    if (32 - t.length > 0)
                        for (var o = 0, u = 32 - t.length; o < u; o++)
                            t += "0";
                    32 - t.length < 0 && (t = t.substring(0, 32)),
                    e.get("sessionId") ? t = e.get("sessionId") : e.add("sessionId", t),
                    AppSession.data.id = this.sessionId = t
                },
                setSessionTime: function() {
                    var t;
                    t = (new Date).getTime(),
                    e.get("SessionStart") ? t = e.get("SessionStart") : e.add("SessionStart", t),
                    AppSession.data.start = parseInt(t)
                },
                setInitTime: function() {
                    localData.get("initTime") ? DTGlobal.appProfile.initTime = parseInt(localData.get("initTime")) : (DTGlobal.appProfile.initTime = WebappStart,
                    localData.add("initTime", WebappStart))
                },
                setPartner: function() {
                ...
                addlastSession: function() {
                    ...
                    e === undefined && (localData.delLocalStorage("sessionMsg"),
                    localData.delLocalStorage("lastSession"));
                    if (!e)
                        ...
                        if (t.id != AppSession.data["id"]) {
                            ...
                            TDBASE.addMsg(n),
                            this.timedif = parseInt(((new Date).getTime() - localData.get("leavetime")) / 1e3),
                            localData.add("T-%%%-T", "{" + (new Date(parseInt(localData.get("leavetime")))).toLocaleString().replace(/年|月/g, "-").replace(/日/g, " ") + "," + (new Date(parseInt(AppSession.data.start))).toLocaleString().replace(/年|月/g, "-").replace(/日/g, " ") + "}"),
                            localData.get("appkey") ? localData.get("appkey") == DTGlobal.appkey && TDBASE.addSessionStart(this.timedif, 1) : TDBASE.addSessionStart(this.timedif, 1);
                            return
                        }
                    }
                },
                getAjax: function() {
                    var e = this
                      , t = new UrlRequest;
                    localStorage.__TD_sessionMsg || TDBASE.addSessionStart(0, 2);
                    var n = TDJSON.parse(localData.get("sessionMsg"))
                    ...
                    if (i) {
                        ...
                        if (s) {
                            var o = s.data.events;
                            s.data.events = o.concat(TDJSON.parse(i))
                        }
                    }
                    localData.delLocalStorage("td-init-event"),
            ...
            window.DTMgr = r,
            window.location.href.indexOf("tdTimecc") == -1 && r.set()
        }(),
        function() {
            function t() {
                var e = window.location.href;
                TD_SDK_CONFIG.HYBRID_PAGE_NAME == "title" && (e = window.document.title),
                hybridEvent.send("onPage", [e])
            }
            ...
            var e = {
                loadURL: function(e) {
                    ...
                    document.body && t.parentNode.removeChild(t),
                    t = null
                },
                exec: function(t, n) {
                    var r = {
            ...
            window.hybridEvent.send = e.exec,
            setTimeout(function() {
                t()
            }, 100)
        }();
        var SDKEvent = {
            set: function(e, t, n) {
                ...
                if (arguments.length > 0)
                    try {
                        ...
                        e != undefined && (r.id = typeof e != "string" ? TDJSON.stringify(e) : e),
                        t != undefined ? r.label = typeof t != "string" ? TDJSON.stringify(t) : t : r.label = "";
                        if (n != undefined) {
                            var i = function(e) {
            ...
            webUpload: function(e) {
                TDXHR ? TDBASE.addGenre(e, "events", function(e) {
                    ...
                    r || t.push(e),
                    localData.add("td-hold-event", TDJSON.stringify(t))
                }) : TDBASE.addGenre(e, "events"),
                TD_SDK_CONFIG.AUTO_SEND_EVENT && DTMgr.getAjax()
            },
            hybridEventUpload: function(e) {
                ...
                e.id && (n = [e.id],
                t = "onEvent",
                e.label && (n.push(e.label),
                t = "onEventWithLabel",
                e.params && (n.push(e.params),
                t = "onEventWithParameters"))),
                hybridEvent.send(t, n)
            },
        ...
        window.TDAPP = window.TDAPP || {},
        window.TDAPP.send = SDKEvent.req,
        window.TDAPP.onEvent = SDKEvent.set,
        TDIsWebviewFlag ? (TDAPP.getDeviceId = SDKEvent.hybridGetDeviceId,
        TDAPP.onEventWithLabel = SDKEvent.set,
        TDAPP.onEventWithParameters = SDKEvent.set,
        TDAPP.setLocation = SDKEvent.hybridSetLocation) : (TDAPP.onEventWithLabel = function() {}
        ,
        ...
        if (!TDIsWebviewFlag) {
            var SDKPage = {
                ...
                onPageEnd: function(e) {
                    ...
                    t && (t = TDJSON.parse(t),
                    SDKPage.onPageStart(t.name, t.title, t.refer, !0, e),
                    localData.delLocalStorage("lastPage"))
                }
            };
            window.TDAPP = window.TDAPP || {},
            window.TDAPP.onCustomPage = SDKPage.onPageStart
        }
        (function(e, t, n) {
            ...
            var e = {
              ...
              , t = function() {
                ...
                return n.prototype = {
                    _organiseData: function(e, t) {
                        var n = e[this._xField]
                          , i = e[this._yField]
                          , s = this._radi
                          , o = this._data
                          , u = this._max
                          , a = this._min
                          , f = e[this._valueField] || 1
                          , l = e.radius || this._cfgRadius || r;
                        o[n] || (o[n] = [],
                        s[n] = []),
                        o[n][i] ? o[n][i] += f : (o[n][i] = f,
                        s[n][i] = l);
                        var c = o[n][i];
                        return c > u ? (t ? this.setDataMax(c) : this._max = c,
                        !1) : c < a ? (t ? this.setDataMin(c) : this._min = c,
                        !1) : {
                            x: n,
                            y: i,
                            value: f,
                    ...
                    addData: function() {
                        if (arguments[0].length > 0) {
                            ...
                            n && (this._data.length === 0 && (this._min = this._max = n.value),
                    ...
                    setData: function(e) {
                        ...
                        this._radi = [];
                        for (var r = 0; r < n; r++)
                            this._organiseData(t[r], !1);
                        return this._max = e.max,
                        this._min = e.min || 0,
              ...
              , n = function() {
                function i(e) {
                    var n = e.container
                      ...
                      , s = this._renderBoundaries = [1e4, 1e4, 0, 0]
                      , o = getComputedStyle(e.container) || {};
                    i.className = "heatmap-canvas",
                    this._width = i.width = r.width = e.width || +o.width.replace(/px/, ""),
                    this._height = i.height = r.height = e.height || +o.height.replace(/px/, ""),
                    this.shadowCtx = r.getContext("2d"),
                    this.ctx = i.getContext("2d"),
                    i.style.cssText = r.style.cssText = "position:absolute;left:0;top:0;",
                ...
                return i.prototype = {
                    renderPartial: function(e) {
                        e.data.length > 0 && (this._drawAlpha(e),
                        this._colorize())
                    },
                    renderAll: function(e) {
                        this._clear(),
                        e.data.length > 0 && (this._drawAlpha(r(e)),
                        this._colorize())
                    },
                    ...
                    _setStyles: function(e) {
                        this._blur = e.blur == 0 ? 0 : e.blur || e.defaultBlur,
                        ...
                        this._opacity = (e.opacity || 0) * 255,
                        this._maxOpacity = (e.maxOpacity || e.defaultMaxOpacity) * 255,
                        this._minOpacity = (e.minOpacity || e.defaultMinOpacity) * 255,
                    ...
                    _drawAlpha: function(e) {
                        var t = this._min = e.min
                          ...
                          , s = 1 - this._blur;
                        while (i--) {
                            var o = e[i], u = o.x, a = o.y, f = o.radius, l = Math.min(o.value, r), c = u - f, h = a - f, p = this.shadowCtx, d;
                            this._templates[f] ? d = this._templates[f] : this._templates[f] = d = n(f, s);
                            var v = (l - t) / (r - t);
                            p.globalAlpha = v < .01 ? .01 : v,
                            p.drawImage(d, c, h),
                            c < this._renderBoundaries[0] && (this._renderBoundaries[0] = c),
                            h < this._renderBoundaries[1] && (this._renderBoundaries[1] = h),
                            c + 2 * f > this._renderBoundaries[2] && (this._renderBoundaries[2] = c + 2 * f),
                            h + 2 * f > this._renderBoundaries[3] && (this._renderBoundaries[3] = h + 2 * f)
                        }
                    },
                    _colorize: function() {
                        var e = this._renderBoundaries[0]
                          , t = this._renderBoundaries[1]
                          , n = this._renderBoundaries[2] - e
                        ...
                        e + n > i && (n = i - e),
                        t + r > s && (r = s - t);
                        var l = this.shadowCtx.getImageData(e, t, n, r)
                          , c = l.data
                          , h = c.length
                          , p = this._palette;
                        for (var d = 3; d < h; d += 4) {
                        ...
                        l.data = c,
                        this.ctx.putImageData(l, e, t),
                        this._renderBoundaries = [1e3, 1e3, 0, 0]
                    },
                    getValueAt: function(e) {
                        var t, n = this.shadowCtx, r = n.getImageData(e.x, e.y, 1, 1), i = r.data[3], s = this._max, o = this._min;
                        return t = Math.abs(s - o) * (i / 255) >> 0,
                        t
                    },
                    getDataURL: function() {
              ...
              , r = function() {
                var r = !1;
                return e.defaultRenderer === "canvas2d" && (r = n),
                r
            }()
              , i = {
                merge: function() {
              ...
              , s = function() {
                function u() {
                    ...
                    if (n.plugin) {
                        var u = n.plugin;
                        if (!e.plugins[u])
                            throw new Error("Plugin '" + u + "' not found. Maybe it was not registered.");
                        var a = e.plugins[u];
                        this._renderer = new a.renderer(n),
                        this._store = new a.store(n)
                    } else
                        this._renderer = new r(n),
                        this._store = new t(n);
                    o(this)
                }
                var s = function() {
                  ...
                  , o = function(e) {
                    var t = e._renderer
                      , n = e._coordinator
                      , r = e._store;
                    n.on("renderpartial", t.renderPartial, t),
                    n.on("renderall", t.renderAll, t),
                    n.on("extremachange", function(t) {
                ...
                return u.prototype = {
                    addData: function() {
                        return this._store.addData.apply(this._store, arguments),
                        this
                    },
                    removeData: function() {
                        return this._store.removeData && this._store.removeData.apply(this._store, arguments),
                        this
                    },
                    setData: function() {
                        return this._store.setData.apply(this._store, arguments),
                        this
                    },
                    setDataMax: function() {
                        return this._store.setDataMax.apply(this._store, arguments),
                        this
                    },
                    setDataMin: function() {
                        return this._store.setDataMin.apply(this._store, arguments),
                        this
                    },
                    configure: function(e) {
                        return this._config = i.merge(this._config, e),
                        this._renderer.updateConfig(this._config),
                        this._coordinator.emit("renderall", this._store._getInternalData()),
                        this
                    },
                    repaint: function() {
                        return this._coordinator.emit("renderall", this._store._getInternalData()),
                        this
                    },
                    getData: function() {
        ...
        function() {
            var e = {
                ...
                tdHeatMapData: {},
                blockPixel: 10,
                calPageLoadDuration: function() {
                    var e = (new Date).getTime()
                      , t = e - WebappStart
                      , n = "_td_page_load_duration"
                      , r = "_td_page_load_duration"
                      , i = {
                ...
                getElementPath: function(e) {
                    ...
                    t.build = function() {
                        for (var e = 0; e < r; e++) {
                            ...
                            if (s && s != "#document") {
                                s = s.toLowerCase();
                                if (t.id && i && i.indexOf("#") == -1)
                                    i += "#" + t.id + ">";
                                else if (t.previousSibling && s != "html" && s != "body") {
                                    var o = t.parentNode
                                      , u = o.children || o.childNodes
                                      , a = 0;
                                    for (var f = 0; f < u.length; f++) {
                                        var l = u[f];
                                        if (l == t)
                ...
                buildPointByEvent: function(t) {
                    var n = t.clientX + document.body.scrollLeft + document.documentElement.scrollLeft
                      ...
                      , a = s.offsetWidth
                      , f = s.offsetHeight
                      , l = e.getPointCenter(n - u, i)
                      , c = e.getPointCenter(r - o, i)
                      , h = Math.min(a, l)
                      , p = Math.min(f, c)
                      , d = {
                        x: h,
                ...
                getPointCenter: function(e, t) {
                    ...
                    if (e && t && e > t) {
                        var i = e / t;
                        i.toString().indexOf(".") != -1 ? r = Math.floor(i) : r = Math.floor(i),
                        n = (r - 1) * t + t / 2
                    }
                    return n
                },
                buildElementPath: function(e) {
                    ...
                    return n.push(r),
                    t.build = function(e) {
                        e.parentNode && (n.push(e.parentNode),
                        t.build(e.parentNode))
                    }
                    ,
                    t.build(r),
                    n
                ...
                getElementAttribute: function(t) {
                    var n = t.target || t.srcElement
                      , r = e.buildPointByEvent(t)
                      , i = {
                        path: e.getElementPath(t),
                        url: e.getElementUrl(t),
                        point: {
                            x: e.toDecimal(r.x / n.offsetWidth, 3),
                            y: e.toDecimal(r.y / n.offsetHeight, 3)
                        }
                    };
                    return i
                },
                onEventByElems: function(t) {
                    var n = "_td_heat_map_click"
                      , r = ""
                      , i = {
                        pageId: e.pageId,
                        elem: e.getElementAttribute(t)
                    };
                    TDAPP.onEvent(n, r, i),
                    TDAPP.send()
                },
                ...
                getOnEventByElem: function(t) {
                    if (t.tagName == "body" || t.tagName == "BODY" || t.tagName == "html" || t.tagName == "HTML")
                        return;
                    if (t.hasAttribute("td-event")) {
                        var n = t.getAttribute("td-event");
                        e.onEventByValue(n)
                    } else
                        t.parentNode && e.getOnEventByElem(t.parentNode)
                },
                ...
                createHeatMapHtml: function() {
                    var t = e.tdPageFlag
                      , n = document.getElementById("td-heat-map-panel");
                    n && n.parentNode.removeChild(n);
                    var r = document.body;
                    r.style.height = "auto";
                    var i = e.getWindowsWH()
                      , s = document.createElement("div");
                    s.style.cssText = "position: absolute;width: 100%;height: 100%;top: 0;left: 0;z-index:9999;",
                    s.setAttribute("class", "td-heat-map-panel"),
                    s.setAttribute("id", "td-heat-map-panel"),
                    s.style.height = i.height + "px",
                    s.style.minHeight = i.minHeight + "px";
                    var o = "";
                    o += '<div class="heat-map-bg" style="position: fixed;top: 0;left: 0;width: 100%;height: 100%;background-color: #000;opacity: .3;filter: alpha(opacity=30);-moz-opacity: .3;-khtml-opacity: .3;"></div>',
                    o += '<div class="heat-map-content" style="position: absolute; top: 0;left: 0;width: 100%;height: 100%;color: #fff;">',
                    o += '<div class="heat-map-cavans" id="td-heat-map-cavans" style="height:100%;width:100%;"></div>',
                    o += "</div>",
                    s.innerHTML = o,
                    r.appendChild(s)
                },
                ...
                getHeatMapData: function() {
                    var t = e.tdHeatMapData
                      , n = t.elems
                      , r = e.tdPageFlag;
                    return r == "tdHeatMapLink" && (n = e.filterHeatMapDataByElem(n)),
                    n
                },
                ...
                transPointByObject: function(t, n) {
                    var r = e.getTop(n)
                      , i = e.getLeft(n)
                      , s = parseInt(parseFloat(t.x) * n.offsetWidth + i)
                      , o = parseInt(parseFloat(t.y) * n.offsetHeight + r)
                      , u = {
                        clickNum: t.clickNum,
                        x: s,
                        y: o
                ...
                getPointsByElem: function(t) {
                    var n = []
                      , r = e.getObjectByPath(t.path);
                    if (r && t && t.points && t.points.length > 0)
                ...
                createHeatMap: function() {
                    ...
                    var n = TdHeatMap.create({
                      ...
                      , r = e.getHeatMapData()
                      , i = e.rebuildHeatMapData(r)
                      , s = {
                        max: e.getHeatMapMax(i),
                        data: i
                    };
                    n.setData(s)
                },
                ...
                getTop: function(t) {
                    var n = t.offsetTop;
                    return t.offsetParent != null && (n += e.getTop(t.offsetParent)),
                    n
                },
                getLeft: function(t) {
                    var n = t.offsetLeft;
                    return t.offsetParent != null && (n += e.getLeft(t.offsetParent)),
                    n
                },
                createPathHtmlByPath: function() {
                    var t = e.getPointsSum()
                      , n = e.getWindowsWH()
                      , r = e.tdPageFlag
                      , i = document.querySelector("#td-heat-map-cavans")
                      , s = e.getHeatMapData();
                        ...
                        for (var o = 0; o < s.length; o++) {
                            ...
                            if (u.path != "html" && u.path != "html>body") {
                                ...
                                if (a) {
                                    ...
                                    r == "tdHeatMapLink" ? (p.style.background = "rgb(110, 172, 249)",
                                    p.style.opacity = "0.5") : p.style.background = "rgba(0,0,0,0)",
                                    p.style.zIndex = u.zIndex,
                                    p.style.width = l + "px",
                                    p.style.height = f + "px",
                                    ...
                                    var d = e.calElementValueBySamePath(u.path)
                                      , v = 0;
                                    t > 0 && (v = d / t * 100,
                                    v < 1 ? v = e.toDecimal(v, 2) : v = e.toDecimal(v, 2));
                                    var m = d + "（" + v + "%）";
                                    p.setAttribute("td-heat-map-text", m),
                                    p.setAttribute("td-heat-map-value", d),
                                    p.setAttribute("td-heat-map-percent", v),
                                    p.setAttribute("path", u.path);
                                    if (r == "tdHeatMapLink") {
                                        var g = u.uv || "";
                                        p.setAttribute("td-heat-map-uv", g),
                                        p.style.lineHeight = f + "px",
                                    ...
                                    H5Event.addEventListener(p, "click", e.pathHtmlMouseClick),
                                    H5Event.addEventListener(p, "mouseenter", e.pathHtmlMouseEnter),
                                    H5Event.addEventListener(p, "mouseleave", e.pathHtmlMouseLeave),
                                    i.appendChild(p)
                                }
                            }
                        }
                ...
                createTooptipHtml: function(t) {
                    ...
                    l.setAttribute("id", "td-heat-map-tooltip-panel"),
                    ...
                    var c = ""
                      , h = s.getAttribute("td-heat-map-text") || 0
                      , p = s.getAttribute("td-heat-map-uv") || 0
                      , d = s.getAttribute("td-heat-map-value") || 0
                      , v = s.getAttribute("td-heat-map-percent") || 0;
                    r == "tdHeatMapLink" ? (l.style.background = "rgba(0,0,0,1)",
                    c += "<div><span>访客数：</span><span>" + p + "</span></div>",
                    c += "<div><span>点击数：</span><span>" + d + "</span></div>",
                    c += "<div><span>点击占比：</span><span>" + v + "%</span></div>") : c += "<div><span>点击数：</span><span>" + h + "</span></div>",
                    l.innerHTML = c,
                    i.appendChild(l),
                    a + l.offsetHeight >= n.minHeight && a + l.offsetHeight >= n.height && (a = o - l.offsetHeight,
                    a < 0 && (a = 0),
                    l.style.top = a + "px"),
                    f + l.offsetWidth >= n.width && (f = n.width - l.offsetWidth,
                    f < 0 && (f = 0),
                    l.style.left = f + "px")
                },
                ...
                pathHtmlMouseLeave: function(t) {
                    ...
                    n == "tdHeatMapLink" && (r.style.background = "rgb(110, 172, 249)",
                ...
                pathHtmlMouseEnter: function(t) {
                    ...
                    n == "tdHeatMapLink" ? (r.style.background = "rgb(18, 120, 246)",
                    r.style.opacity = "0.95") : r.style.border = "1px solid #fff",
                    e.createTooptipHtml(t)
                },
                getWindowsWH: function() {
                    var e = {};
                    return e.width = document.body.clientWidth,
                    e.height = document.body.clientHeight,
                    e.minHeight = window.innerHeight,
                    e
                },
                initHeatMapData: function(t) {
                    var n = TDJSON.parse(t.data);
                    e.tdPageFlag = n.tdPageFlag || "",
                    e.tdHeatMapData = n.data,
                    e.initHeatMap()
                },
                getSourceId: function() {
                    var e = ""
                      , t = TD_SDK_CONFIG.SDK_VERSION || "";
                    if (t && t.indexOf("+") != -1) {
                        var n = t.split("+")[0];
                        n == "WEB" ? e = "1" : n == "H5" && (e = "2")
                    }
                ...
                checkIsCollectHeatMapData: function() {
                    var t = DTGlobal.appkey || ""
                      , n = e.getSourceId();
                    if (!t || !n || !TD_SDK_CONFIG.USER_CLICK_MAP_REQURL)
                        return !1;
                    var r = {
                        appkey: t,
                        sourceid: n,
                    ...
                    i.set(r, function(t) {
                        ...
                        if (t && t.page) {
                            ...
                            TDAPP.onEvent("_td_heat_map_pv", "", r),
                            e.listenerPageClick()
                        }
                    }, function(e) {
                        console.log(e)
                ...
                initHeatMap: function() {
                    var t = e.tdPageFlag;
                    t == "tdHeatMap" || t == "tdHeatMapLink" ? (e.rendHeatMap(),
                ...
                listenerPageLoaded: function() {
                    ...
                    else if (document.all && !window.opera && H5Event.getIeVersion() < 9) {
                ...
                init: function() {
                    TD_SDK_CONFIG.EVENT_BY_ELEMENT && e.bindEventForTdEventElement(),
                    TD_SDK_CONFIG.PAGE_LOAD_DURATION && e.calPageLoadDuration();
                    if (TDIsWebviewFlag)
                        return;
                    TD_SDK_CONFIG.USER_CLICK_MAP && (window.frames.length != parent.frames.length ? (e.listenerPageLoaded(),
                    H5Event.addEventListener(window, "message", e.initHeatMapData)) : e.initHeatMap())
                }
            };
            e.init()
        }();
